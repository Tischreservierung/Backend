...
namespace Persistence.Data
{
    public class ReservationRepository : IReservationRepository
    {
        ...
        {
            return await _context.Reservation.Where(r => r.CustomerId == customerId).ToListAsync();
        }

        public async Task<IEnumerable<Reservation>> GetReservationsByRestaurant(int restaurantId)
        {
            return await _context.Reservation.Where(r => r.RestaurantId == restaurantId).ToListAsync();
        }
